...
class LayoutGroupContentInsetsViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        navigationItem.title = "LayoutGroup.contentInsets"
...
extension LayoutGroupContentInsetsViewController {
...
extension LayoutGroupContentInsetsViewController {
    private func createLayout() -> UICollectionViewLayout {
        let layout = IBPUICollectionViewCompositionalLayout(sectionProvider: { (sectionIndex: Int, _: IBPNSCollectionLayoutEnvironment) -> IBPNSCollectionLayoutSection? in
            ...
            switch section {
            case .one: return LayoutGroupContentInsetsViewController.createOneColumnLayout()
            case .two: return LayoutGroupContentInsetsViewController.createTwoColumnLayout()
            case .three: return LayoutGroupContentInsetsViewController.createThreeColumnLayout()
            }
        })
        return layout
    }
